package com.nooy.home.controller;
...
public class HomeController {
	...
	public String joinOk(HttpServletRequest request, HttpSession session, Model model) {
		...
		int joinFlag = dao.memberJoin(mid, mpw, mname, memail, mtel);
	...
	@RequestMapping(value = "/placeInsertOk")
	public String placeInsertOk(HttpServletRequest request) {
		
		String bid = request.getParameter("bid");//글쓴유저 아이디
		String bregion = request.getParameter("bregion");//글쓴유저 이름
		String baddress = request.getParameter("baddress");//글쓴 질문 내용
		String bprice = request.getParameter("bprice");
		String brule = request.getParameter("brule");
		String bemail = request.getParameter("bemail");
	
		IDao dao = sqlSession.getMapper(IDao.class);
		
		dao.placeInsert(bid, bregion, baddress, bprice, brule, bemail);
		
		return "redirect:list";
	}
	@RequestMapping(value = "bookList")
	public String bookList(Model model, Criteria cri, HttpServletRequest request) {
		...
		List<PlaceDto> placeDtos = dao.bookList(cri);
		
		
		model.addAttribute("pageMaker", pageDto);
		model.addAttribute("pdtos", placeDtos);
		model.addAttribute("currPage", pageNumInt);
	...
	public String placeDelete(HttpServletRequest request) {
		...
		dao.placeDelete(bnum);
		
		return "redirect:placeInsert";
	}
	@RequestMapping(value = "/myPlace")
	public String myPlace(HttpServletRequest request) {
